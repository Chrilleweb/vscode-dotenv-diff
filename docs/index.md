...
`vscode-dotenv-diff` solves this by analysing your `.ts` and `.js` files, suggesting missing `.env` keys while you type, and surfacing warnings exactly where problems exist — without any configuration.
